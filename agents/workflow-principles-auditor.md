...
description: "Reviews a Claude Code Workflow engine (a background Workflow .mjs script such as feature-cycle.mjs) against the fourteen Workflow Principles — gaps, violations, over-engineering, agent roles that could be eliminated. Use after writing a new engine or changing an existing one's agent/harness structure."
